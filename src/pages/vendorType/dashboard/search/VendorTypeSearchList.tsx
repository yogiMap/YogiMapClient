...
const VendorTypeSearchList = (props: IProps) => {
  const queryParams = get(props, 'location.query', {});
  const items = get(props, 'items', []);

  const columns: ColumnProps<IVendorType>[] = [
    {
      title: 'Name',
      key: 'name',
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(VendorTypeSearchList));

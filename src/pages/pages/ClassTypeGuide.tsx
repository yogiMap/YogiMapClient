      ...
      <div id="main-col" className="main-col">
        <div className="panel">
          ...
          <div className="format-text">
            ...
            <h3>
              <a href="/s?f%5B0%5D=style%3A584">Laughter</a>
            </h3>
            <p>
              Laughter yoga (Hasyayoga) is a practice involving prolonged voluntary laughter. It's based on the belief
              that this provides the same physiological and psychological benefits as spontaneous laughter. Done in
              groups, laughter is initially simulated as a physical exercise while maintaining eye contact with others
              in the group and promoting childlike playfulness. In most cases this soon leads to real and contagious
              laughter!
            </p>
            <h3>
            ...
            <p>
              Odaka Yoga founded by Roberto Milletti and Francesca Cassia. It provides a full-spectrum approach to
              embodying the flow of life with awareness, joy and empowerment. Odaka Yoga unfolds through yoga sequences
              and through the martial arts flow of inner energy, and the Zen spirit of not stilling the mind. It
            ...
            <p>
              Phoenix Rising Yoga Therapy was founded by Michael Lee in 1986 and takes a holistic, client-centered
              approach to yoga for therapy. It emphazises the mental, emotional, and even spiritual aspects of healing
              over the purely physical nature of health issues.
            </p>
            <h3>
              <a href="/s?f%5B0%5D=style%3A568">Power</a>
            </h3>
            <p>
              Power Yoga is a general term used to describe classes that are often based on the flowing and dynamic
              style of Ashtanga Yoga, but that don't necessarily follow the same set series of poses. Classes can vary
              depending on the teacher, but they generally offer a vigorous workout that develops strength and
              flexibility while keeping students moving. Power Yoga classes often target different muscle groups; they
              can be as challenging for the mind as they are for the body. Power Yoga generally appeals to people who
              enjoy exercise, and prefer a minimal amount of meditation and chanting.
            </p>
            <h3>
              <a href="/s?f%5B0%5D=style%3A605">Pranayama</a>
            </h3>
            <p>
              Pranayama is the formal practice of controlling the breath, and describes of series of exercises
              especially intended to keep the body in vibrant health, and to help yogis in the meditation practice.
            ...
            <h3>
              <a href="/s?f%5B0%5D=style%3A570">Restorative</a>
            </h3>
            <p>
              Restorative Yoga helps to open the body through passive stretching so that practitioners can access a deep
              conscious relaxation. A typical class will include several floor poses held passively for a longer amount
              of time than in other styles of yoga, with the support of blocks, bolsters and blankets to eliminate any
            ...
            <p>
              Developed by Zhander Remete, Shadow yoga focuses on awakening the inner core of the body and of the self.
              The emphasis in beginning Shadow Yoga is on understanding the energetic principles, applied through of
              core locks and proper breathing technique. Shadow Yoga is popular with practitioners who are interested in
              experiencing a practice that goes beyond alignment and flow, and exploring core body energy and breath.{' '}
            </p>
            <h3>
            ...
            <h3>
              <a href="/s?f%5B0%5D=style%3A587">Thai Yoga Massage</a>
            </h3>
            <p>
              A system of massage and manipulation developed in Thailand, and influenced by the traditional medicine
              systems of India, China, and Southeast Asia, as well as by yoga. Developed more than 2,500 years ago in
              India, it's related to yoga because the therapist uses his or her hands, knees, legs, and feet to move you
              into a series of yoga-like stretches. Many people say Thai yoga massage is like doing yoga without any
              work.
            </p>
            <h3>
              <a href="/s?f%5B0%5D=style%3A590">TriYoga</a>
            </h3>
            <p>
              TriYoga is a hatha yoga method with an emphasis on asanas, breathing, and mudra (focus). This yoga style
              consists of 7 levels, and within each level, students increase their knowledge of posture and flow, as
              well as comprehensively building strength, flexibility, endurance and breath control. Students of all
              levels practice together, modifying sequences to their own abilities. The origin and continued development
              of TriYoga is guided by Kali Ray.
            </p>
            <h3>
            ...
            <h3>
              <a href="/s?f%5B0%5D=style%3A623">Yogalates</a>
            </h3>
            <p>
              Yogalates combines the best of Yoga and Pilates — fusing functional applied anatomy and physiology to
              holistic stability encompassing all of the musculo skeletal body. Classes integrate the core strengthening
              and alignment principles of Pilates with the practice of hatha yoga.
            </p>
          </div>
        </div>
      </div>

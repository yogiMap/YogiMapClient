...
import { querySipPhoneDeleteById, querySipPhoneGetStats, querySipPhoneSearch } from '@/pages/sipPhone/queries';
import { ISipPhone, ISipPhoneStats } from '@/pages/sipPhone/types';
